...
%\documentclass[10pt, a4paper, twocolumn, top=4cm,bottom=3.5cm, right=1.2cm,left=1.5cm]{ResearchNotes}
...
\keywords[Keywords:]{Spatiotemporal, Climate variability, Malaria prevalence.}
% Do not delete the next line, just let the attributes empty 
% in case you do not want to provide logos.
\logos{chicas_logo}{medicalschool}
